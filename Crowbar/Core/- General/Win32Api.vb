...
Public Class Win32Api
	...
	'Public Declare Function SendMessage Lib "user32" Alias "SendMessage" (ByVal hWnd As IntPtr, ByVal Msg As WindowsMessages, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As IntPtr
	<DllImport("user32.dll", SetLastError:=True, CharSet:=CharSet.Unicode)>
	Public Shared Function SendMessage(ByVal hWnd As IntPtr, ByVal Msg As WindowsMessages, ByVal wParam As IntPtr, ByVal lParam As IntPtr) As IntPtr
	End Function

	<DllImport("user32.dll", SetLastError:=True, CharSet:=CharSet.Unicode)>
	Public Shared Function SendMessage(ByVal hWnd As IntPtr, ByVal Msg As WindowsMessages, ByVal wParam As SB, ByVal lParam As IntPtr) As IntPtr
	End Function

	<DllImport("user32.dll", SetLastError:=True, CharSet:=CharSet.Unicode)>
	Public Shared Function SendMessage(ByVal hWnd As IntPtr, ByVal Msg As WindowsMessages, ByVal wParam As UInt32, ByVal lParam As IntPtr) As IntPtr
	End Function
